...
public class ElasticSearchToExampleSetOperator extends AbstractReader<ExampleSet> implements ESParameterProvider {

	public static final String PARAMETER_CONNECTION = "Connection";
	private static final Logger LOGGER = Logger.getLogger(ElasticSearchToExampleSetOperator.class.getName());
	...
	public ExampleSet read() throws OperatorException {
		...
		try
		{
			...
			LOGGER.info("These are teh setings" );
			//LOGGER.info(metadata.index("twitter5").getSettings()
			...
			LOGGER.finest("HERE IS THE INDEX SELECTED" + indexsuggestion);
	...
	public List<ParameterType> getParameterTypes()
	{
		...
		ParameterTypeSuggestion indexsuggestion = new ParameterTypeSuggestion("INDEXSUGGESTIONS","TEST INDEX SUGGESTIONS",new ElasticSearchSuggestionProvider(this, ElasticSearchSuggestionProvider.Type.INDEX));
